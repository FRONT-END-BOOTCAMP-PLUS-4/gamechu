...
export default function ProfileTierCard({ score }: Props) {
    ...
    return (
        <div className="h-[270px] w-full flex-1 rounded-xl bg-background-300 p-6 shadow">
            {/* 제목 & 설명 */}
            <div className="mb-4 flex items-start justify-between">
                <div>
                    <h2 className="text-body font-semibold">현재 티어</h2>
                </div>
            ...
            {/* 데스크탑 */}
            <div className="mt-auto grid hidden grid-cols-5 gap-3 text-center text-caption lg:grid">
                {tiers.map((tier) => {
                    const isActive = tier.label === currentTier.label;
                    return (
                        <div
